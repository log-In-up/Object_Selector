...
namespace PotionsSelector
{
    ...
    public sealed class PotionsSelectorUI : MonoBehaviour
    {
        ...
        private Sender<PotionsData> _charactersSender = null;
        #endregion
        ...
        private void Awake()
        {
            ...
            _charactersSender = new Sender<PotionsData>(ConstAppData.POTIONS);
        }
        ...
        {
            PotionsData data = _charactersSender.GetObject();
